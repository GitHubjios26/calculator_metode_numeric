...
?>
<main>
<h4><a href="mencari_akar.php">Mencari Akar</a> -> <a href="secant.php">Metode Secant</a></h4>
    <div class="form-container">
        <form method="GET" action="hitung_secant.php">
    ...
    <h4>Riwayat || <a href="hapus_secant.php"> hapus riwayat</a></h4>
    <?php include('conection_secant.php'); ?>
</main>
<?php
