...
?>
<main>
<h4><a href="mencari_akar.php">Mencari Akar</a> -> <a href="regulafalsi.php">Metode Regulafalsi</a> -> <a href="hitung_regulafalsi.php">Hitung Regulafalsi</a></h4>
    ...
    mysqli_query($koneksi, $query_delete);
                ...
                if (f($X1, $akar) * f($X2, $akar) > 0) {
                    ...
                    do {
                        $iterasi++;
                        $X = $X1 - (f($X1, $akar) * (($X2 - $X1) / (f($X2, $akar) - f($X1, $akar))));
                        $fX = f($X, $akar);
                        $fX1 = f($X1, $akar);
                        ...
                        $query = "INSERT INTO regulafalsi (`no`, `x1`, `x2`, `x`, `fx`, `fx1`, `keterangan`) VALUES ('$iterasi', '$X1', '$X2', '$X', '$fX', '$fX1', '$keterangan')";
